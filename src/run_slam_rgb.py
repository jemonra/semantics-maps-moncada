...
if __name__ == "__main__":
    ...
    args_parser.add_argument("--scene_id", type=str, default="train_3")
    args_parser.add_argument("--image_height", type=int, default=480)
    args_parser.add_argument("--image_width", type=int, default=640)

    args_parser.add_argument("--start", type=int, default=0)
    args_parser.add_argument("--end", type=int, default=-1)
    args_parser.add_argument("--stride", type=int, default=1)

    args_parser.add_argument("--visualize", action="store_true")
    args_parser.add_argument("--save_pcd", action="store_true")

    args_parser.add_argument("--seed", type=int, default=42)
    args_parser.add_argument("--device", type=str, default="cuda")

    args_parser.add_argument("--load_semseg", action="store_true",
